                    ...
                    case deleteType::DELETEID_USER:{
                        ...
                        switch (deleteopt) {
                                case 'y':
                                        ...
                                        cout << "\n\t\t\t\t>>> Your Bus Driver's name "<<num <<" has been deleted <<<\n";
                    ...
                    case deleteType::DELETENAME_USER:
                        ...
                        switch (deleteopt) {
                            case 'y':
                                ...
                                cout << "\n\t\t\t\t>>> Your Bus Driver's name "<<name <<" has been deleted <<<\n";
                                userManager.deleteUserbyName(name);
                    ...
                    do
                    {
                        ...
                        switch (op3) {
                            case searchType::SEARCH_ID:{
                                ...
                                if ((bus = busoffice.getBusById(num))) {
                                      bus->outputbeforeedit();
                                }
                                            else {
                            ...
                            case searchType::SEARCH_NAME:{
                                Bus* bus;
                                                    ...
                                                    cin >> name;
                                                   busoffice.getBusbyName(name);
                                if ((bus = busoffice.getBusbyName(name))) {
                                      bus->outputbeforeedit();
                                }
                                else {
                    
                                    cout <<"\n\t\t\t\t>>> SEARCHING BUS DRIVER'S NAME NOT FOUND <<<"<< endl;
